(define (problem itinerario_basico)
  ...
  (:init
    ...
    (= (interes madrid) 2)
    (= (interes paris) 2)
    (= (interes roma) 1) ;; Roma es el destino de más interés
    (= (interes londres) 2)
    (= (interes-total) 0)
  ...
  ;; Métrica ponderada: Priorizando el mayor INTERÉS (multiplicamos el interés por un peso alto)
  (:metric minimize (+ (* 1 (precio-total)) (* 10000 (interes-total))))
